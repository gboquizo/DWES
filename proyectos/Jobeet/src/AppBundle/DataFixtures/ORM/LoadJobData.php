...
class LoadJobData extends AbstractFixture implements FixtureInterface
{
  public function load(ObjectManager $em)
  {
    ...
    $job_sensio_labs->setExpiresAt(new \DateTime('2019-10-10'));
    ...
    for($i = 100; $i <= 130; $i++)
  {
    ...
    $job->setCreatedAt(new \DateTime('2019-02-28'));
    $job->setUpdatedAt(new \DateTime('2019-03-01'));
    $job->setExpiresAt(new \DateTime('2019-10-10'));
