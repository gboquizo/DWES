 ...
 * @Date: 10/11/18
 * @Description: Define el social media general para el header del sitio.
...
<div class="social-icon-header">
    ...
    <a href="https://github.com/gboquizo" target="blank">
        <i id="social-gh" class="fab fa-github-square fa-3x icon" title="GitHub"></i>
    </a>
    <a href="mailto:guillermoboquizosanchez@gmail.com?Subject=Hola%20de%20nuevo" target="blank">
        <i id="social-em" class="fas fa-envelope-square fa-3x icon" title="Correo"></i>
    </a>
</div>